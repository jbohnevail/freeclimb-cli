  ...
  "message": "Response from server"
    ...
    describe("applications:delete next flag test", function () {
        it("Tests return of Exit Code 3 when flag next is not available", async () => {
            const orig_FREECLIMB_APPLICATIONS_DELETE_NEXT =
                process.env.FREECLIMB_APPLICATIONS_DELETE_NEXT
            ...
            try {
                ...
                if (orig_FREECLIMB_APPLICATIONS_DELETE_NEXT === undefined)
                    delete process.env.FREECLIMB_APPLICATIONS_DELETE_NEXT
                else
                    process.env.FREECLIMB_APPLICATIONS_DELETE_NEXT =
                        orig_FREECLIMB_APPLICATIONS_DELETE_NEXT
            }
        })
    })
})
