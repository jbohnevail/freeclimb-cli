  ...
  "message": "Response from server"
    ...
    describe("conference-participants:get next flag test", function () {
        it("Tests return of Exit Code 3 when flag next is not available", async () => {
            const orig_FREECLIMB_CONFERENCE_PARTICIPANTS_GET_NEXT =
                process.env.FREECLIMB_CONFERENCE_PARTICIPANTS_GET_NEXT
            ...
            try {
                ...
                if (orig_FREECLIMB_CONFERENCE_PARTICIPANTS_GET_NEXT === undefined)
                    delete process.env.FREECLIMB_CONFERENCE_PARTICIPANTS_GET_NEXT
                else
                    process.env.FREECLIMB_CONFERENCE_PARTICIPANTS_GET_NEXT =
                        orig_FREECLIMB_CONFERENCE_PARTICIPANTS_GET_NEXT
            }
        })
    })
})
