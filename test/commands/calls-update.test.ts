...
describe("calls:update Data Test", function () {
  ...
  "message": "Response from server"
    ...
    it("Test Freeclimb Api error repsonce is process correctly without a suggestion", async () => {
        ...
        const { error } = await runCommand(["calls:update", "userInput-callId", "userInput-status"])
    ...
    describe("calls:update next flag test", function () {
        it("Tests return of Exit Code 3 when flag next is not available", async () => {
            const orig_FREECLIMB_CALLS_UPDATE_NEXT = process.env.FREECLIMB_CALLS_UPDATE_NEXT
            ...
            try {
                ...
                if (orig_FREECLIMB_CALLS_UPDATE_NEXT === undefined)
                    delete process.env.FREECLIMB_CALLS_UPDATE_NEXT
                else process.env.FREECLIMB_CALLS_UPDATE_NEXT = orig_FREECLIMB_CALLS_UPDATE_NEXT
            }
        })
    })
})
