...
describe("incoming-numbers:buy Data Test", function () {
  ...
  "message": "Response from server"
    ...
    it("Test Freeclimb Api error repsonce is process correctly without a suggestion", async () => {
        ...
        const { error } = await runCommand(["incoming-numbers:buy", "userInput-phoneNumber"])
    ...
    describe("incoming-numbers:buy next flag test", function () {
        it("Tests return of Exit Code 3 when flag next is not available", async () => {
            const orig_FREECLIMB_INCOMING_NUMBERS_BUY_NEXT =
                process.env.FREECLIMB_INCOMING_NUMBERS_BUY_NEXT
            ...
            try {
                ...
                if (orig_FREECLIMB_INCOMING_NUMBERS_BUY_NEXT === undefined)
                    delete process.env.FREECLIMB_INCOMING_NUMBERS_BUY_NEXT
                else
                    process.env.FREECLIMB_INCOMING_NUMBERS_BUY_NEXT =
                        orig_FREECLIMB_INCOMING_NUMBERS_BUY_NEXT
            }
        })
    })
})
