  ...
  "message": "Response from server"
    ...
    it("Test all required paramaters", async () => {
        nock("https://www.freeclimb.com")
            ...
            .query({})
            .reply(200, testJson)
        const { stdout, stderr } = await runCommand(["calls:list-call", "userInput-callId"])
    ...
    describe("calls:list-call next flag test", function () {
        it("Tests return of Exit Code 3 when flag next is not available", async () => {
            const orig_FREECLIMB_CALLS_LIST_CALL_NEXT = process.env.FREECLIMB_CALLS_LIST_CALL_NEXT
            ...
            try {
                ...
                if (orig_FREECLIMB_CALLS_LIST_CALL_NEXT === undefined)
                    delete process.env.FREECLIMB_CALLS_LIST_CALL_NEXT
                else
                    process.env.FREECLIMB_CALLS_LIST_CALL_NEXT = orig_FREECLIMB_CALLS_LIST_CALL_NEXT
            }
        })
