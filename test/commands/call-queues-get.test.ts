  ...
  "message": "Response from server"
    ...
    describe("call-queues:get next flag test", function () {
        ...
        it("Tests return of Exit Code 3 when flag next is not available", async () => {
            ...
            process.env.FREECLIMB_CALL_QUEUES_GET_NEXT = undefined
            try {
                ...
                if (orig !== undefined) process.env.FREECLIMB_CALL_QUEUES_GET_NEXT = orig
                else delete process.env.FREECLIMB_CALL_QUEUES_GET_NEXT
            }
        })
    })
})
