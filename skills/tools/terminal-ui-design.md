...
- Custom Unicode: Mix symbols for unique frames

Avoid defaulting to simple single-line boxes. Consider asymmetric borders, double-thick headers, or decorative corners.
...
- Color-coded semantic meaning (but avoid cliche red=bad, green=good)
...
- Unicode symbols: Enrich text with arrows, bullets, stars, mathematical symbols
- Custom bullets: Replace - with themed symbols
...
- Progress bars: Block characters, or creative alternatives
...
## Data Display
- Sparklines: Block characters for inline mini-charts
- Bar charts: Horizontal bars with block characters
- Tables: Smart column sizing, alternating row colors, aligned numbers
- Trees: Standard tree characters for hierarchies
- Status indicators: Filled/empty/partial circles, check/x marks
- Gauges: Block-based percentage bars

## Decorative Elements

Add character without clutter:
- Dividers: Various line styles, dots, wave characters
- Section markers: Arrow markers, bracketed headers, line-framed headers
- Background textures: Patterns using light characters
