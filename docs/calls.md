...
```
USAGE
  $ freeclimb calls:get [CALLID] [--json] [--fields <value>] [-h]
...
_See code: [src/commands/calls/get.ts](https://github.com/FreeClimbAPI/freeclimb-cli/blob/v0.6.0/src/commands/calls/get.ts)_
...
USAGE
  $ freeclimb calls:list [-T <value>] [-f <value>] [-S <value>] [-s <value>] [-e <value>] [-P <value>] [-a
    true|false] [-n] [--json] [--fields <value>] [-h]
...
_See code: [src/commands/calls/list.ts](https://github.com/FreeClimbAPI/freeclimb-cli/blob/v0.6.0/src/commands/calls/list.ts)_
...
_See code: [src/commands/calls/list-call.ts](https://github.com/FreeClimbAPI/freeclimb-cli/blob/v0.6.0/src/commands/calls/list-call.ts)_
...
_See code: [src/commands/calls/list-call-logs.ts](https://github.com/FreeClimbAPI/freeclimb-cli/blob/v0.6.0/src/commands/calls/list-call-logs.ts)_
...
```
USAGE
  $ freeclimb calls:make [FROM] [TO] [APPLICATIONID] [-c <value>] [-P <value>] [-s <value>] [-i <value>] [-I
    <value>] [-t <value>] [-p true|false] [--json] [--fields <value>] [--dry-run] [-h]
...
_See code: [src/commands/calls/make.ts](https://github.com/FreeClimbAPI/freeclimb-cli/blob/v0.6.0/src/commands/calls/make.ts)_
...
```
USAGE
  $ freeclimb calls:update [CALLID] [STATUS] [--json] [--fields <value>] [--dry-run] [-h]

ARGUMENTS
  [CALLID]  String that uniquely identifies this call resource.
  [STATUS]  Either canceled or completed. Specifying canceled attempts to hang up calls that are queued without
            affecting calls already in progress. Specifying completed attempts to hang up a call already in progress.
...
_See code: [src/commands/calls/update.ts](https://github.com/FreeClimbAPI/freeclimb-cli/blob/v0.6.0/src/commands/calls/update.ts)_
