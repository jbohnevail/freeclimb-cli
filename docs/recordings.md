...
```
USAGE
  $ freeclimb recordings:delete [RECORDINGID] [--json] [--fields <value>] [--dry-run] [-h]
...
```
USAGE
  $ freeclimb recordings:download [RECORDINGID] [--json] [--fields <value>] [-h]
...
```
USAGE
  $ freeclimb recordings:get [RECORDINGID] [--json] [--fields <value>] [-h]
...
```
USAGE
  $ freeclimb recordings:list [-c <value>] [-C <value>] [-d <value>] [-n] [--json] [--fields <value>] [-h]
...
```
USAGE
  $ freeclimb recordings:stream [RECORDINGID] [--json] [--fields <value>] [-h]
