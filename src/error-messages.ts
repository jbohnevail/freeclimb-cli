...
errorMessage.set(
    0,
    "Either a service was inaccessible or was configured wrong. This error can occurs if login credentials are not valid. Re-run the login command. If error persists, something went wrong on FreeClimb's end. Please try again. Our engineers are hard at work resolving this problem.",
)
...
errorMessage.set(55, "The server will be back shortly.")
...
export function errorWithSuggestions(errorM: { code: number; message: string; url: string }) {
