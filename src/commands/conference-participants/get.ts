    ...
    async run() {
        ...
        const normalResponse = (response: FreeClimbResponse) => {
            if (response.status === 204) {
                ...
                if (outputFormat === "json") {
                    out.out(JSON.stringify(wrapJsonOutput(null, { command: "conference-participants:get", request: { method: "GET", endpoint: `Conferences/${args.conferenceId}/Participants/${args.callId}` } }), null, 2))
                } else {
