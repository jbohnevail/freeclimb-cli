...
name: cli-workflows
description: >
    Multi-step CLI recipes: onboarding, debugging failed calls, bulk operations, provisioning
    Use when: workflow, onboard, provision, debug call, bulk.
    Do NOT use for: tasks better handled by freeclimb-cli-usage.
---
