...
description: >
    Core FreeClimb concepts: accounts, applications, webhooks, phone numbers, resource model, trial restrictions
    Use when: freeclimb, telephony, voice, sms, communications.
---
